...
public class InvoiceGUIFrame extends JFrame {
    ...
    private void createInvoicePanel() {
        ...
        customer = new Customer("Sam's Small Appliances", "100 Main Street", "Anytown", "CA", "98765");
    ...
    private void populateProductComboBox() {
        ...
        products.add(new Product("Toaster", 29.95));
        products.add(new Product("Hair Dryer", 24.95));
        products.add(new Product("Car Vacuum", 19.99));
    }
